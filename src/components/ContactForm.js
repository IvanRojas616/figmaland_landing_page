  ...
  return (
    <section className="flex flex-col px-16 mb-10">
      <article className="flex flex-col justify-center  items-center">
        <h2 className="text-black text-5xl font-normal mb-12 md:mb-5">
          Contact Us
        </h2>
      ...
      <article className="flex flex-col-reverse md:flex-row justify-center">
        <form className="mb-16 md:mb-0 py-5 px-8 rounded-md shadow-lg shadow-slate-400 md:w-3/12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col-reverse md:flex-col justify-center items-center w-8/12 ml-10">
          <ul className="flex flex-col md:flex-row text-black w-full mt-10 mb-5 md:mr-20">
            <li className="flex flex-row md:flex-col justify-start md:justify-center items-center">
              <img
                src={PinIcon}
                alt="pinner"
                className="mr-2 w-4 h-5 without_filters mb-2"
              />
              <h5 className="text-xs text-left md:text-center w-4/5 md:w-3/5">
                6386 Spring St undefined Anchorage, Georgia 12473 United States
              </h5>
            </li>
            <li className="flex flex-row md:flex-col justify-start md:justify-center items-center md:w-2/5 md:pr-24">
              <img
                src={PhoneIcon}
                alt="phone"
            ...
            <li className="flex flex-row md:flex-col justify-start md:justify-center items-center pr-5">
              <img
                src={MailIcon}
                alt="mail"
                className="mx-2 w-4 h-5 without_filters mb-2"
          ...
          <ul className="flex flex-row justify-center md:justify-start pl-16 md:pl-0 w-full mt-10">
            <li>
              <img
                src={TwitterIcon}
                alt="twitter"
